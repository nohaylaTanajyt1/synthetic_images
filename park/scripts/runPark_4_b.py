...
json_file_path = '/baie/nfs-cluster-1/data1/raid1/homedirs/nohayla.tanajyt/Stage/ScenesAssets/park/json_files/obj8.json'
...
output_file = os.path.join(output_dir, f"park_4_b.jpg")
