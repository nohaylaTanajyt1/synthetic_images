...
json_file_path = '/baie/nfs-cluster-1/data1/raid1/homedirs/nohayla.tanajyt/Stage/ScenesAssets/park/json_files/obj1.json'
...
# Base directory path
base_dir = '/baie/nfs-cluster-1/data1/raid1/homedirs/nohayla.tanajyt/Stage/ScenesAssets/park/'
...
img_name = 'kloofendal_48d_partly_cloudy_puresky_4k.exr'
...
output_file = os.path.join(output_dir, f"park_1_a.jpg")
