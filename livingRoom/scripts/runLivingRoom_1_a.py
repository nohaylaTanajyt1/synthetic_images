...
# JSON file path containing scene data
json_file_path = '/baie/nfs-cluster-1/data1/raid1/homedirs/nohayla.tanajyt/Stage/ScenesAssets/livingRoom/json_files/obj1.json'
...
# Base directory path
base_dir = '/baie/nfs-cluster-1/data1/raid1/homedirs/nohayla.tanajyt/Stage/ScenesAssets/livingRoom/'

# Get the current scene and its node tree
...
tree_nodes.clear()
# Create shader nodes for background, environment texture, mapping, and output
...
# Load background image and set mapping scale
background_image_dir = os.path.join(base_dir, 'bkg')
img_name = 'limehouse_4k.exr'
...
# Link nodes for background, environment, and output
...
# Get the "objects" list from JSON data
...
for obj_data in objects:
    ...
    # Loop through objects in the scene and apply settings (location, rotation, and textures)
...
light_object.location = (0.03436249867081642,-0.004006850067526102,1.2300000190734863)
light_object.rotation_euler = (0,0,0)

light_data.energy = 100
light_data.size = 4.0

# Set Cycles as the render engine and configure rendering settings
...
# Set the output path and resolution for rendering
output_dir = os.path.join(base_dir, 'outputs')
output_file = os.path.join(output_dir, f"livingRoom_1_a.jpg")
