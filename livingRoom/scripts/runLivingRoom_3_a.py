...
json_file_path = '/baie/nfs-cluster-1/data1/raid1/homedirs/nohayla.tanajyt/Stage/ScenesAssets/livingRoom/json_files/obj5.json'
...
output_file = os.path.join(output_dir, f"livingRoom_3_a.jpg")
