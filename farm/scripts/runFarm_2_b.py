...
json_file_path = '/baie/nfs-cluster-1/data1/raid1/homedirs/nohayla.tanajyt/Stage/ScenesAssets/farm/json_files/obj4.json'
...
output_file = os.path.join(output_dir, f"farm_2_b.jpg")
