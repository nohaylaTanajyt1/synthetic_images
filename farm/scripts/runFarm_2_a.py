...
json_file_path = '/baie/nfs-cluster-1/data1/raid1/homedirs/nohayla.tanajyt/Stage/ScenesAssets/farm/json_files/obj3.json'
...
output_file = os.path.join(output_dir, f"farm_2_a.jpg")
