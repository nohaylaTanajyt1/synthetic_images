...
json_file_path = '/baie/nfs-cluster-1/data1/raid1/homedirs/nohayla.tanajyt/Stage/ScenesAssets/smalloffice/json_files/obj1.json'
...
# Base directory path
base_dir = '/baie/nfs-cluster-1/data1/raid1/homedirs/nohayla.tanajyt/Stage/ScenesAssets/smalloffice/'
...
# deleting textures from objects 
...
output_file = os.path.join(output_dir, f"office_1_a.jpg")
